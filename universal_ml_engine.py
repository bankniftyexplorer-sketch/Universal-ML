...
ARTIFACT_NAME_SCHEME = {
    ...
    "VOL": {
        ...
        "model_5d_logvol": "{prefix}_VOL_model_5d_logvol.pkl",
        "model_5d_range": "{prefix}_VOL_model_5d_range.pkl",
        "model_5d_up_exc": "{prefix}_VOL_model_5d_up_exc.pkl",
        "model_5d_dn_exc": "{prefix}_VOL_model_5d_dn_exc.pkl",
        "features": "{prefix}_VOL_features.txt",
        "oos_forecasts": "{prefix}_VOL_oos_forecasts.pkl",
        "calibrators": "{prefix}_VOL_calibrators.pkl",
        "conformal": "{prefix}_VOL_conformal.pkl",
